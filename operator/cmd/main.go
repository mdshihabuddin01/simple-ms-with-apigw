...
import (
	...
	"github.com/mdshihabuddin01/simple-ms-with-apigw/operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(cermanagerv1.AddToScheme(scheme))
	utilruntime.Must(acmeissuerv1.AddToScheme(scheme))
	utilruntime.Must(certmanagermetav1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4b75a642.example.com",
	...
	certManagerClientSet, err := certmanagerclient.NewForConfig(mgr.GetConfig())
	if err != nil {
		setupLog.Error(err, "failed to create cert manager clientset")
	}

	/*	KubeClientSet, err := controllers.GetAllClients()
		if err != nil {
			setupLog.Error(err, "unable to get Kube Client")
		}
	*/
